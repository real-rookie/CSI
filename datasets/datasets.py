...
def get_dataset(P, dataset, test_only=False, image_size=None, download=False, eval=False):
    ...
    if dataset == 'cifar10':
        ...
        image_size = (500, 500, 3)
        n_classes = 142
        train_set = datasets.INaturalist(DATA_PATH, "2021_train_mini", target_type="kingdom", transform=train_transform, download=False)
        test_set = datasets.INaturalist(DATA_PATH, "2021_valid", target_type="kingdom", transform=test_transform, download=False)
